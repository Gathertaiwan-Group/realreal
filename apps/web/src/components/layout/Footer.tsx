  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 sm:gap-16 max-w-4xl mx-auto">
          ...
          {/* Right: Links + Social (nested 2-col) */}
          <div className="grid grid-cols-2 gap-8">
            ...
            {/* Social */}
            <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
              <p className="mb-4 text-base font-semibold tracking-wide">
                追蹤我們
                <span className="block text-xs font-normal opacity-60 tracking-widest mt-0.5">Follow us</span>
              </p>
